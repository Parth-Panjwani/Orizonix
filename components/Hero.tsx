...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 md:px-8 pt-20">
      ...
      <div className="absolute bottom-1/4 right-0 w-96 h-96 bg-neon-purple/10 rounded-full blur-3xl creative-blob" style={{ animationDelay: '1s' }} />
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-neon-pink/10 rounded-full blur-3xl creative-blob" style={{ animationDelay: '2s' }} />
      ...
      <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          <motion.div
            ...
            className="absolute top-1/2 right-0 w-24 h-24 bg-gradient-to-br from-neon-blue/20 to-neon-purple/20 rounded-full blur-xl"
          />
          <motion.div
            animate={{
              y: [0, 30, 0],
            ...
            className="absolute bottom-1/4 right-1/4 w-20 h-20 bg-gradient-to-br from-neon-purple/20 to-neon-pink/20 rounded-full blur-xl"
          />
        </motion.div>
      </div>
    </section>
